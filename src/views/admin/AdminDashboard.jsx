        ...
        <div className='px-2 md:px-7 py-5'>
            <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7'>
                <div className='flex justify-between items-center p-5 bg-primary rounded-md gap-3'>
                    <div className='flex flex-col justify-start items-start text-white'>
                        <h2 className='text-3xl font-bold'>NGN{totalSale}</h2>
            ...
            <div className='w-full flex flex-wrap mt-7'>
                ...
                <div className='w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0'>
                    <div className='w-full bg-primary p-4 rounded-md text-white'>
                            ...
                            <ol className='relative border-1 border-slate-600 ml-4'>
                                {
                                    recentMessage.map((m, i) => <li className='mb-3 ml-6'>
                                        ...
                                        <div className='p-3 bg-secondary rounded-lg border border-slate-600 shadow-sm'>
                                            ...
                                            <div className='p-2 text-xs font-normal bg-secondary rounded-lg border border-slate-800'>
                                                {m.message}
                                            </div>
                                        </div>
                                    </li>)
                        ...
                        <tbody>
                            {
                                recentOrders.map((d, i) => <tr key={i}>
                                    ...
                                    <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>NGN{d.price}</td>
