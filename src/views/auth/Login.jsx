    ...
    <div className='min-w-screen min-h-screen bg-secondary flex justify-center items-center'>
      <div className='w-[350px] text-white p-2'>
        <div className='bg-primary p-4 rounded-md'>
          <h2 className='text-xl mb-3'>Welcome to your dashbaord</h2>
          ...
          <form onSubmit={submit}>
            ...
            <div className='flex flex-col w-full gap-1 mb-5'>
              ...
              {/* <input onChange={inputHandle} value={state.password} className='px-3 py-2 outline-none border border-white bg-transparent rounded-md text-white focus:border-secondary overflow-hidden' type="password" name='password' placeholder='password' id='password' required /> */}
            ...
            <div className='w-full flex justify-center items-center mb-3'>
              <div className='w-[45%] bg-secondary h-[1px]'></div>
