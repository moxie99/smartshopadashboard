                ...
                <div className='flex w-full h-full relative'>
                    ...
                    <div className='w-full md:pl-4'>
                        <div className='flex justify-between items-center'>
                            <div className='flex justify-start items-center gap-3'>
                                <div className='relative'>
                                    <img className='w-[42px] h-[42px] border-green-500 border-2 max-w-[42px] p-[2px] rounded-full' src={admin} alt="" />
                                    {
                        ...
                        <form onSubmit={send} className='flex gap-3'>
                            <input value={text} onChange={(e) => setText(e.target.value)} className='w-full flex justify-between px-2 border border-secondary items-center py-[5px] focus:border-blue-500 rounded-md outline-none bg-transparent text-white' type="text" placeholder='input your message' />
