            ...
            <div className='w-full h-[calc(100vh-177px)] bg-[#252b3b] md:bg-transparent overflow-y-auto'>
              ...
              {customers.map((c, i) => (
                <Link
                  ...
                  className={`h-[60px] flex justify-start gap-2 items-center text-white px-2 py-2 rounded-sm cursor-pointer bg-secondary`}
                >
          ...
          <div className='w-full md:w-[calc(100%-200px)] md:pl-4'>
            ...
            <form onSubmit={send} className='flex gap-3'>
              <input
                ...
                value={text}
                className='w-full flex justify-between px-2 border border-secondary items-center py-[5px] focus:border-blue-500 rounded-md outline-none bg-transparent text-white'
                type='text'
